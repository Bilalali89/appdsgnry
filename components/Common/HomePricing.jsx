          ...
          <div className="container">
            <div className="section-title">
              ...
              <p
                ...
                data-aos-delay="500"
              >
                Now Presenting Priceless Digital Solutions At Less And
                Affordable Price.
              </p>
            </div>
              ...
              >
                <div id="tab1" className="tabs_item">
                  <div className="row">
                    ...
                    <div className="col-lg-4 col-sm-6">
                      <div className="single-pricing-table">
                        ...
                        <ul className="pricing-features">
                          <li>
                            <i className="icofont-check-circled"></i>2 Logo
                            Concepts
                          </li>
                          <li>
                          ...
                          <li>
                            <i className="icofont-check-circled"></i>3 rounds of
                            Revision
                          </li>
                          <li>
                            <i className="icofont-check-circled"></i>
                    ...
                    <div className="col-lg-4 col-sm-6">
                      <div className="single-pricing-table">
                        <div className="pricing-header">PROFESSIONAL</div>
                        ...
                        <ul className="pricing-features">
                          <li>
                            <i className="icofont-check-circled"></i>6 Logo
                            Concepts
                          </li>
                          <li>
                            <i className="icofont-check-circled"></i>
                          ...
                          <li>
                            <i className="icofont-check-circled"></i>100%
                            Ownership
                          </li>
                        </ul>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-4 col-sm-6">
                      <div className="single-pricing-table">
                        ...
                        <ul className="pricing-features">
                          <li>
                            <i className="icofont-check-circled"></i>2 Website
                            Designs
                          </li>
                          <li>
                            <i className="icofont-check-circled"></i>
                    ...
                    <div className="col-lg-4 col-sm-6">
                      <div className="single-pricing-table">
                        ...
                        <ul className="pricing-features">
                          <li>
                            <i className="icofont-check-circled"></i>6 Website
                            Designs
                          </li>
                          <li>
                            <i className="icofont-check-circled"></i>
