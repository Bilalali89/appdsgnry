            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-footer-widget">
                ...
                <p>
                  ...
                  most experienced and skilled creatives, around the world. Our
                  professionals have high commands over experience design apps.
                </p>
                <div className="worktogether1">
                  <Link href="/contact">
                    <span className="letswork">LET'S WORK TOGETHER</span>
                  </Link>
                </div>
              ...
              <div className="row mt-50">
                <div className="col-lg-6 col-sm-6">
                  <div className="single-footer-widget footer_contact">
                    ...
                    <div className="mb-30">
                      <img src="/images/call-icon-blue.png" alt="img" /> +1 618
                      458 65441
                    </div>
                    <div>
                      <img src="/images/email-icons-blue.png" alt="img" />{" "}
                      info@appdsgnry.com
                    </div>
                  </div>
                </div>
